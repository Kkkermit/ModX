    ...
    async execute (interaction) {
        ...
        switch (sub) {
            ...
            const rule = await guild.autoModerationRules.create({
                name: `Block profinity, sexual content, and slurs by Orbit.exe.`,
                ...
                actions: [
                    {
                        ...
                        metadata: {
                            ...
                            durationSeconds: 10,
                            customMessage: 'This message was prevented by Orbit.exe!'
                        }
                    }
                ]
            }).catch(async err => {
            ...
            setTimeout(async () => {
                ...
                .setThumbnail('https://cdn.discordapp.com/attachments/1129094438669520956/1131553432008937573/ModX.png')
            ...
            const rule2 = await guild.autoModerationRules.create({
                name: `Prevent the word ${word} by Orbit.exe.`,
                creatorId: '1096437714439647243',
                enabled: true,
                eventType: 1,
                triggerType: 1,
            ...
            const rule3 = await guild.autoModerationRules.create({
                name: 'Prevent Spam Messages by Orbit.exe.',
                creatorId: '1096437714439647243',
                enabled: true,
                eventType: 1,
                triggerType: 5,
            ...
            const rule4 = await guild.autoModerationRules.create({
                name: `Prevent Spam Mentions by Orbit.exe.`,
                creatorId: '1096437714439647243',
                enabled: true,
                eventType: 1,
                triggerType: 5,
