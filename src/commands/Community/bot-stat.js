...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        .addComponents(
            ...
            .setLabel('Bot Invite')
            .setStyle(ButtonStyle.Link)
            .setURL("https://discord.com/api/oauth2/authorize?client_id=1096437714439647243&permissions=8&scope=bot%20applications.commands")
        )
        ...
        .setFooter({ text: `🤖 ModX's statistics`})
        .setTimestamp()
        ...
        .setDescription('> ModX is fuctioning correctly.')
